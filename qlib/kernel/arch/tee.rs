...
pub fn gpa_to_ipa(address: &mut u64, protect: bool) {
    if is_hw_tee() {
...
pub fn is_protected_address(gpa: u64) -> bool {
    ...
    if (gpa >= MemoryDef::FILE_MAP_OFFSET &&
        ...
        || (gpa == MemoryDef::HYPERCALL_MMIO_BASE) {
            res = false;
    }
    res
}
...
pub fn call_host(hcall_type: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64) {
    #[cfg(target_arch = "aarch64")]
    _tee::rsi::RsiHostCall::rsi_host_call(hcall_type, arg1, arg2, arg3, arg4);
}

/// Entry call to the booting flow of other vCPUS.
/// Internals are architecture depended.
pub fn boot_others(boot_help_data: u64, vcpu_count: u64, pc: u64) {
    #[cfg(target_arch = "aarch64")]
    _tee::psci::cpu_on(boot_help_data as *const u64, vcpu_count, pc);
