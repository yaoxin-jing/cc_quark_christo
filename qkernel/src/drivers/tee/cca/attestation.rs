...
use crate::drivers::tee::attestation::{Response, Challenge};
...
impl AttestationDriverT for ArmCcaHwAttester {
    fn valid_challenge(&self, challenge: &mut Challenge) -> bool {
    ...
    fn get_report(&mut self, challenge: &Challenge) -> Result<Response> {
